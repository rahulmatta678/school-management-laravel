                ...
                <div class="p-12">
                    <div class="mb-10">
                        <h2 class="text-3xl font-black text-white uppercase italic tracking-tighter leading-none">
                            Add New Parent<span class="text-indigo-500">.</span>
                        </h2>
                        <p class="text-slate-500 mt-2 font-bold uppercase text-[10px] tracking-[0.2em]">Register contact information and student links</p>
                    </div>

                    <form action="{{ route('teacher.parents.store') }}" method="POST" class="space-y-10">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div>
                                ...
                                <div class="relative group/select">
                                    <select id="student_id" name="student_id" class="w-full border-white/10 focus:border-indigo-600 focus:ring-0 rounded-2xl bg-white/[0.02] text-white transition-all py-4 px-6 font-black uppercase italic text-xs tracking-widest appearance-none cursor-pointer" required>
                                        <option value="" class="bg-black text-slate-500">-- Choose a Student --</option>
                                        @foreach ($students as $student)
                                            <option value="{{ $student->id }}" class="bg-black text-white" {{ old('student_id') == $student->id ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <x-text-input id="name" class="block w-full" type="text" name="name" :value="old('name')" required placeholder="Full Name" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div>
                                ...
                                <x-text-input id="email" class="block w-full" type="email" name="email" :value="old('email')" required placeholder="email@example.com" />
                            ...
                            <div>
                                ...
                                <x-text-input id="phone" class="block w-full" type="text" name="phone" :value="old('phone')" placeholder="+1 (555) 000-0000" />
                        ...
                        <div class="flex items-center justify-between gap-4 mt-12 pt-10 border-t border-white/5">
                            <div class="flex-1 max-w-[200px]">
                                <x-primary-button>{{ __('Register Parent') }}</x-primary-button>
                            </div>
